...
# function hex_to_str()
#------------------------------------------------------------------------------
# Writes a 32-bit number in hexadecimal lowercase format to a string buffer, followed by
# the newline character and the NULL-terminator. 
# The output should always contain 10 characters (8 digits, 1 newline, 1 NUL-terminator).
#
# For example:
#  0xabcd1234 => "abcd1234\n\0"
#  0x134565FF => "134565ff\n\0"
